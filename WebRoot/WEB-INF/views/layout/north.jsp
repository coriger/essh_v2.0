...
function showAbout(){
	...
	login_about_dialog = $('<div/>').dialog({
		...
		height : 220,
		modal : true,
		href : '${ctx}/fileRedirect?toPage=layout/about.jsp',
		buttons : [{
			text : '关闭',
			iconCls : 'icon-cancel',
			handler : function() {
 ...
 function initLoginPasswordForm(){
   ...
   function editLoginUserPassword(){
	...
	login_about_dialog = $('<div/>').dialog({
		...
		height : 240,
		modal : true,
		href : '${ctx}/fileRedirect?toPage=layout/north-password.jsp',
		buttons : [{
			text : '保存',
			iconCls : 'icon-save',
			handler : function() {
...
<div style="background-image: url(${ctx}/static/img/top_bg.png); background-repeat: repeat-x;">
    <div style="float: left;">
	    <img alt="essh" title="永远的小女儿" class="easyui-tooltip" data-options="position:'right'" src="${ctx}/static/img/essh_logo.png">
	</div>
