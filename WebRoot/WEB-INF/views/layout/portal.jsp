...
<script type="text/javascript" charset="utf-8">
	$(function() {
		panels = [ {
			...
			height : 360,
			collapsible : true,
			href:'${ctx}/fileRedirect?toPage=layout/portal-bug.jsp'
		}, {
			id : 'p2',
			title : '技术架构',
			height : 360,
			collapsible : true,
			href : '${ctx}/fileRedirect?toPage=layout/portal-component.jsp'
		}];
...
<div class="easyui-layout" fit="true" style="width:100%;height:100%;overflow: hidden;">
	...
	<div  style="height: 100%;width:200px;overflow: hidden;"
          data-options="region:'east',title:'日历',href:'${ctx}/fileRedirect?toPage=layout/portal-east.jsp'">
	</div>
</div>
