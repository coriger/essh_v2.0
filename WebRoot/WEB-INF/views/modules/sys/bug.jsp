...
<%-- 引入kindEditor插件 --%>
<link rel="stylesheet" href="${ctx}/static/js/kindeditor-4.1.7/themes/default/default.css">
<script type="text/javascript" src="${ctx}/static/js/kindeditor-4.1.7/kindeditor-all-min.js" charset="utf-8"></script>
<%--<script type="text/javascript" src="${ctx}/static/js/jquery/easyui-1.3.4/jquery.easyui.kindeditor.js" charset="utf-8"></script>--%>
