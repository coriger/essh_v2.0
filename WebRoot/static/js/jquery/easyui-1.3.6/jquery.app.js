...
(function ($) {
	...
	$.fn.app.defaults = {
		...
		iframeOpen : false,
		loadUrl : { //远程数据加载路径
			app : ctx+'/static/js/jquery/easyui-1.3.6/apps.json', //app数据
			startMenu : ctx+'/static/js/jquery/easyui-1.3.6/startMenu.json', //开始菜单数据
			widget : ctx+'/static/js/jquery/easyui-1.3.6/widget.json'
		},
		lang : { //国际化
			initLayout : "初始化布局",
